...
const Page = async ({ params }) => {
        ...
        return (
            <div className="flex flex-col items-center justify-center min-h-screen">
                ...
                <p className="text-gray-600 mt-2">
                    Sorry, the category you are looking for does not
                    exist.
                </p>
            </div>
        )
    ...
    const storeProductsData = await getStoreCategoryProduct(
        storeData._id,
        slug
    );
    
    // console.log(storeProductsData, "Store Products Data");
