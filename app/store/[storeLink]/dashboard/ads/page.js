...
import AdminBoostDashboard from '@/components/AdminBoostDashboard';
		...
		<ProtectedRoute>
			<div className="flex h-screen">
				...
				<div className="w-full flex md:flex-row flex-col h-full">
					...
					{showMenu && (
						<div className="absolute block md:hidden top-[4.2rem] right-3 mt-0 w-60 z-10 rounded-xl bg-white border border-gray-200 shadow-lg">
							<ul className="flex flex-col">
								...
								<li
									onClick={() => logout()}
									className="px-4 flex flex-row gap-3 cursor-pointer items-center py-2 hover:bg-gray-100"
								>
					...
					<div className="flex flex-col w-full md:w-[80%] h-full">
						...
						<Content>
							<AdminBoostDashboard storeData={storeData} />
							{/* <div className="flex justify-center items-center min-h-screen">
								<div className="text-center bg-white p-10 shadow-md rounded-md">
									<h1 className="text-2xl font-semibold">
										Coming soon!!!
									</h1>
									<a
										className="text-blue-600"
										href="https://boost.tradeet.ng"
										target="_blank"
									>
										Learn more
									</a>
