			...
			<div className="flex h-screen">
				...
				{sidebarOpen && (
					<div className="fixed inset-0  bg-black bg-opacity-50">
						<div className="fixed inset-y-0 z-50 left-0 w-64 bg-white shadow-lg">
				...
				<div className="w-full flex md:flex-row flex-col h-full">
					<header className="w-full bg-white shadow p-4 flex justify-between items-center md:hidden">
						<button
							className="text-2xl"
					...
					<div className="flex flex-col w-full md:w-[80%] h-full">
						...
						<Content>
							<h2 className="text-2xl font-bold mb-4">
								Welcome to the Admin Categories Page
							</h2>
