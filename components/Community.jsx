...
const Community = () => {
  ...
  return (
		<section
			ref={sectionRef}
			id="community"
			className="py-20 bg-gradient-to-br from-[#fcdbb8]/10 to-white"
		>
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				<div className="text-center mb-16">
					...
					<p className="text-xl text-gray-600 max-w-3xl mx-auto">
						Join a thriving community of business owners who
						are growing their income with Tradeet.
					</p>
				</div>
				...
				<div className="grid grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
					<div className="text-center">
						...
						<div className="text-lg font-bold text-[#065637] mb-1">
							Growing Fast
						</div>
							...
							<div className="text-center mb-8">
								...
								<div className="flex items-center justify-center space-x-4">
									...
									<div className="text-left">
										...
										<div className="text-[#065637] font-medium">
											{
												testimonials[currentTestimonial]
													.business
											}
				...
				<div className="mt-16 text-center">
					<div className="bg-[#065637] text-white rounded-2xl p-8 lg:p-12">
						...
						<p className="text-lg opacity-90 mb-6 max-w-2xl mx-auto">
							Connect with fellow entrepreneurs, get
							business tips, and receive exclusive updates
							about new features.
						</p>
						<div className="flex flex-col sm:flex-row gap-4 justify-center">
							<a
								href="https://chat.whatsapp.com/Du8xWBkUB8d66fuq0Qd7ul"
								className="bg-white text-[#065637] px-8 py-4 rounded-xl font-semibold hover:bg-gray-100 transition-colors"
							>
								Join WhatsApp Group
							</a>
							<a
								target="_blank"
								href="https://www.instagram.com/tradeetbusiness/"
								className="border-2 border-white text-white px-8 py-4 rounded-xl font-semibold hover:bg-white hover:text-[#065637] transition-all"
							>
								Follow on Instagram
							</a>
						</div>
